...
const circumference = 48 * 2 * Math.PI; //radius times 2 then times by pi to get the circumference//
let variable = getRandomNumber(27) //27 because the number is generated between 0 - 26 //
...
loader.style.strokeDashoffset = -display //subtracts from the circumference to tell the outer circle where to stop//
